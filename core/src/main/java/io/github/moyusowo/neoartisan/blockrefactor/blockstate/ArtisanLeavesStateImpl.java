...
import io.github.moyusowo.neoartisanapi.api.blockrefactor.blockstate.ArtisanLeavesState;
...
public class ArtisanLeavesStateImpl extends ArtisanBaseBlockStateImpl implements ArtisanLeavesState {
    ...
    protected ArtisanLeavesStateImpl(int appearanceState, int actualState, ItemGenerator[] generators) {
    ...
    private static final class BuilderImpl implements Builder {
        ...
        public @NotNull ArtisanLeavesState build() {
            ...
            return new ArtisanLeavesStateImpl(generateAppearanceState(), actualState, generators);
        }
    }
}
