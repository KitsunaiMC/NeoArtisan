...
final class ArtisanFullBlockDataImpl extends ArtisanBlockBaseDataInternal implements ArtisanFullBlockData {
    ...
    ArtisanFullBlockDataImpl(NamespacedKey blockId, int stage, Location location) {
