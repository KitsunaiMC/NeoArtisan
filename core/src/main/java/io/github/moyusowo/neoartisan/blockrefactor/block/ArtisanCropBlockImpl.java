package io.github.moyusowo.neoartisan.blockrefactor.block;

import io.github.moyusowo.neoartisan.NeoArtisan;
import io.github.moyusowo.neoartisan.util.init.InitMethod;
import io.github.moyusowo.neoartisan.util.init.InitPriority;
import io.github.moyusowo.neoartisanapi.api.block.base.sound.SoundProperty;
import io.github.moyusowo.neoartisanapi.api.blockrefactor.block.ArtisanCropBlock;
...
public class ArtisanCropBlockImpl extends ArtisanBaseBlockImpl implements ArtisanCropBlock {
    ...
    public static final class BuilderImpl implements Builder {
        ...
        @Override
        public @NotNull Builder stages(@NotNull List<ArtisanBaseBlockState> stages) {
            this.stages = stages;
            return this;
        }
