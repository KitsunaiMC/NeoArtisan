 ...
 */
public interface ArtisanHeadBlockState extends ArtisanBlockState {
    /**
     * 获取工厂服务实例
     * <p>
    ...
    @NotNull String getUrlBase64();

    interface Builder extends BaseBuilder {
        @NotNull Builder textureUrl(@NotNull String textureUrl, boolean isBase64);

        @NotNull Builder generators(@NotNull ItemGenerator[] generators);

        @NotNull ArtisanHeadBlockState build();
    }
}
