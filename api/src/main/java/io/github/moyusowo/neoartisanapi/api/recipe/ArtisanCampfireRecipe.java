...
/**
 * Campfire cooking recipe interface, extending the base {@link ArtisanRecipe}.
 *
 * <p><b>Recipe features:</b></p>
 * <ul>
 *   <li>Supports custom cooking time (ticks)</li>
...
public interface ArtisanCampfireRecipe extends ArtisanFurnaceLikeRecipe {
    /**
     * Creates a new builder for constructing {@link ArtisanCampfireRecipe} instances.
     *
    ...
    interface Builder {
        ...
        /**
         * Sets the input ingredient for cooking.
         *
